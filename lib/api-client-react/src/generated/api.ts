...
export const listAllUsers = async (
  ...
  return customFetch<UsersListEnvelope>(getListAllUsersUrl(), {
    ...options,
    method: "GET",
  });
};
...
export type ListAllUsersQueryResult = NonNullable<
  Awaited<ReturnType<typeof listAllUsers>>
>;
export type ListAllUsersQueryError = ErrorType<ErrorEnvelope>;
 ...
 */
export const getUpdateUserAsAdminUrl = (id: string) => {
...
export const updateUserAsAdmin = async (
  ...
  return customFetch<AuthUserEnvelope>(getUpdateUserAsAdminUrl(id), {
    ...options,
    method: "PATCH",
    headers: { "Content-Type": "application/json", ...options?.headers },
...
export const getUpdateUserAsAdminMutationOptions = <
  TError = ErrorType<ErrorEnvelope>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof updateUserAsAdmin>>,
    TError,
  ...
  TContext
> => {
  const mutationKey = ["updateUserAsAdmin"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return updateUserAsAdmin(id, data, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type UpdateUserAsAdminMutationResult = NonNullable<
  Awaited<ReturnType<typeof updateUserAsAdmin>>
>;
export type UpdateUserAsAdminMutationBody = BodyType<UpdateUserRequest>;
export type UpdateUserAsAdminMutationError = ErrorType<ErrorEnvelope>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getUpdateUserAsAdminMutationOptions(options));
};

/**
 * @summary Delete any user (admin only)
 */
export const getDeleteUserAsAdminUrl = (id: string) => {
  return `/api/admin/users/${id}`;
};
...
export const deleteUserAsAdmin = async (
  ...
  return customFetch<LogoutSuccess>(getDeleteUserAsAdminUrl(id), {
    ...options,
    method: "DELETE",
  });
};

export const getDeleteUserAsAdminMutationOptions = <
  TError = ErrorType<ErrorEnvelope>,
  TContext = unknown,
>(options?: {
  mutation?: UseMutationOptions<
    Awaited<ReturnType<typeof deleteUserAsAdmin>>,
    TError,
    { id: string },
    TContext
  >;
  ...
  TContext
> => {
  const mutationKey = ["deleteUserAsAdmin"];
  const { mutation: mutationOptions, request: requestOptions } = options
    ? options.mutation &&
      "mutationKey" in options.mutation &&
      options.mutation.mutationKey
  ...
  > = (props) => {
    ...
    return deleteUserAsAdmin(id, requestOptions);
  };

  return { mutationFn, ...mutationOptions };
};

export type DeleteUserAsAdminMutationResult = NonNullable<
  Awaited<ReturnType<typeof deleteUserAsAdmin>>
>;

export type DeleteUserAsAdminMutationError = ErrorType<ErrorEnvelope>;
...
>(options?: {
  ...
  TContext
> => {
  return useMutation(getDeleteUserAsAdminMutationOptions(options));
};
